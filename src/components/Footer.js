...
const Footer = () => {
  return (
    <div className="w-full mt-24 bg-sky-600 text-gray-800 py-2 px-2">
      ...
      <div className="flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-800">
        <p className="py-4">Yellow Room art house</p>
